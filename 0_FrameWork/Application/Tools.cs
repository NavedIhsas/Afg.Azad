...
namespace _0_Framework.Application
{
    public static class Tools
    {
        ...
        public static DateTime ToGeorgianFullDateTime(this string persianDate)
        {
            persianDate = persianDate.ToEnglishNumber();
            var year = Convert.ToInt32(persianDate.Substring(0, 4));
            var month = Convert.ToInt32(persianDate.Substring(5, 2));
            var day = Convert.ToInt32(persianDate.Substring(8, 2));
            var hours = Convert.ToInt32(persianDate.Substring(11, 2));
            var minutes = Convert.ToInt32(persianDate.Substring(14, 2));
            var sec = Convert.ToInt32(persianDate.Substring(17, 2));
            return new DateTime(year, month, day,hours,minutes,sec, new PersianCalendar());
        }
        ...
        {
            return date.ToShortDateString();
            return date.ToString("yyyy MMMM dd", new CultureInfo("prs-AF"));
        }
