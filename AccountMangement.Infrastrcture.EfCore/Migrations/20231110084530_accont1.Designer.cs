...
namespace AccountManagement.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20231110084530_accont1")]
    partial class accont1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountManagement.Domain.Account.Agg.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 566, DateTimeKind.Local).AddTicks(4381),
                            Email = "navedahsas77@gmail.com",
                            EmailConfirm = true,
                            FirstName = "نوید",
                            Gander = "مرد",
                            IsActive = true,
                            IsDelete = false,
                            LastName = "احساس",
                            Password = "10000.ApVvliODuOhK4qeQx5wSRQ==.ajmQFz17z6nDVFVwcDj/b4IY5Hly8L7BQa6YAfNO85s=",
                            Phone = "077***",
                            RoleId = 6L
                        });
                });
            ...
            modelBuilder.Entity("AccountManagement.Domain.RoleAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(4943),
                            Name = "مدیر سایت"
                        },
                        new
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(4963),
                            Name = "استاد"
                        },
                        new
                        {
                            Id = 3L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(4966),
                            Name = "ادمین"
                        },
                        new
                        {
                            Id = 4L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(4967),
                            Name = "کاربر عادی"
                        },
                        new
                        {
                            Id = 5L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(4969),
                            Name = "بلاگر"
                        },
                        new
                        {
                            Id = 6L,
                            CreationDate = new DateTime(2023, 11, 10, 12, 15, 30, 567, DateTimeKind.Local).AddTicks(5000),
                            Name = "بدون احراز"
                        });
                });
