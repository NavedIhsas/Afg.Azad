...
namespace AccountManagement.Infrastructure.EfCore.Repository
{
    public class RoleRepository : RepositoryBase<long, Role>, IRoleRepository
    {
        ...
        {
            var role = _context.Roles.Where(x => x.Id != RoleType.NoAuthorize).Select(x => new EditRoleViewModel
            {
                Name = x.Name,
                Id = x.Id,
        ...
        {
            return _context.Roles.Where(x=>x.Id !=RoleType.NoAuthorize).Select(x => new RoleViewModel
            {
                Id = x.Id,
                Name = x.Name
