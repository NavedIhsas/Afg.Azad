    ...
    function $(e, t, i, n) {
        ...
        var s = e.querySelector(".gslide-media"),
            l = function (e) {
                ...
                return l.className = "vimeo-video gvideo", l.id = "iframeId", l.src = t, l.style.width = "100%", l.style.height = "100%", i && l.setAttribute("allow", i), l.onload = function () {
            ...
            return n(e, [{
                ...
                value: function () {
                    ...
                    if (C(n.afterSlideLoad) && (v = function () {
                        ...
                        //s.href = document.getElementById("episodeUrl").href;
                        var url = s.href;
                        
                        const stringLength = url.length; 
                        var video = url.charAt(stringLength - 4);
                        if (video != ".") {
                           
                            alert("ویدیو در دسترس نیست");
                        }
